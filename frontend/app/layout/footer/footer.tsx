...
export const Footer = () => {
    return (
        <footer
            className={`py-6 bg-background border border-border text-foreground flex items-center px-6 bottom-0 w-full`}>
                ...
                <nav className={"flex items-start justify-center gap-4"}>
                    <div className={"flex items-center flex-col w-full justify-between gap-1.5"}>
                        ...
                        <div className={"flex flex-col gap-1"}>
                            <Link className={"text-foreground-secondary text-xs font-medium hover:text-foreground"}
                                  href={"/"}>Главная</Link>
                            <Link className={"text-foreground-secondary text-xs font-medium hover:text-foreground"}
